...
- (void)windowDidLoad {
    ...
    self.window.title = [NSString stringWithFormat:@"%@ %@", (self.bookmark ? self.bookmark.displayName : self.machine.bookmark ? self.machine.bookmark.displayName : self.machine.name), self.taskAction];
